...
@Component({
  ...
  selector: 'app-sidebarright-user',
  templateUrl: './sidebarright-user.component.html',
  styleUrls: ['./sidebarright-user.component.sass']
})
export class SidebarrightUserComponent implements OnInit {
