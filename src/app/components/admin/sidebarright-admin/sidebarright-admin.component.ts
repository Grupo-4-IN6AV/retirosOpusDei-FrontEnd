...
@Component({
  ...
  selector: 'app-sidebarright-admin',
  templateUrl: './sidebarright-admin.component.html',
  styleUrls: ['./sidebarright-admin.component.sass']
})
export class SidebarrightAdminComponent implements OnInit
{
