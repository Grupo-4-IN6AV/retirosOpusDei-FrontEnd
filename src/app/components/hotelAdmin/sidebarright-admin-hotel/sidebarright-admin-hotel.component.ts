...
@Component({
  ...
  selector: 'app-sidebarright-admin-hotel',
  templateUrl: './sidebarright-admin-hotel.component.html',
  styleUrls: ['./sidebarright-admin-hotel.component.sass']
})
export class SidebarrightAdminHotelComponent implements OnInit {
