...
@Component({
  selector: 'app-header-admin-hotel',
  templateUrl: './header-admin-hotel.component.html',
  styleUrls: ['./header-admin-hotel.component.sass']
})
export class HeaderAdminHotelComponent implements OnInit, DoCheck {
